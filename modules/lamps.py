...
PREMIUM_WON = {
    "great": 12900,     # 무냥이 재회 대점 — 우리 것
    "full": 9800,       # 재회운 종합        ← 귀연도령 재회운
    "divorce": 9500,    # 이 결혼 여기까지일까 ← 결연도령 끝낼 결혼 인연
    "ox": 8900,         # 붙잡을까 놓을까     ← 파연도령 이별결정
    "secret": 8900,     # 말 못 하는 사이     ← 월영도령 허락받지 못한 사랑
    "mind": 7900,       # 그 사람 속마음      ← 심안도령 상대방 속마음
    "match": 7900,      # 궁합 종합          ← 월하낭자 연인 궁합
    "life": 7900,       # 평생 흐름          ← 백송도사 인생 후반전
    "queer": 7900,      # 성별 빼고 보는 속궁합 ← 청연도령 퀴어 연애 궁합
}
