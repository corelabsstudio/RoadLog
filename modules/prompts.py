...
SPEC: list[dict[str, Any]] = [
    ...
    # 🛑 열쇠를 pet → pet3 로 바꿨다 (2026-09-14 멀티 스피시즈·SS~B+ 개편). 옛 열쇠로 관리자 화면에서 고친 글이
    #    남아 있으면 새 규격(칸 이름)과 안 맞아 글이 비므로, 새 열쇠로 기본값부터 다시 쓴다
    {"key": "pet3", "name": "반려동물 관상",
     "why": "「내가 왕이 될 냥인가?」 — 반려동물(강아지·고양이·햄스터·토끼·새·파충류) 사진 한 장으로 무냥이가 종 식별·SS~B+ 등급·스탯·집사 시너지·공유 카드 칸을 씁니다.",
     "mod": "pet", "attr": "SYSTEM"},
    {"key": "gwan", "name": "관상 해설",
